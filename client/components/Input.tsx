...
const InputComponent: React.FC<InputComponentProps> = ({ textPlaceholder, icon, password }) => {
    ...
    return (
        <View className='w-full  font-montserrat text-lp-blue text-base border border-lp-blue mb-3 px-2 bg-black flex flex-row items-center'>
            <TextInput numberOfLines={1} style={styles.CustomStyleInput} placeholder={textPlaceholder} placeholderTextColor="#03045E" keyboardType={'default'}  secureTextEntry={isPasswordVisible}  />
